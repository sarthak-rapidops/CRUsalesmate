...
const test = (z, bundle) =>
  z.request({ url: 'https://apis-dev.salesmate.io/v3/users' });
...
const includeApiKey = (request, z, bundle) => {
  ...
  console.log("bundle", bundle.authData)
    request.headers.sessionToken = bundle.authData.api_key;
    request.headers['x-linkname'] = bundle.authData.subdomain;
